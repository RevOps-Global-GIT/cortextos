...
const TARGETS: CardTarget[] = [
  {
    ...
    selectors: ['[data-testid*="animal" i]', '[class*="animal" i][class*="card" i]', 'article', '[class*="card" i]'],
  },
  {
    surface: 'GardenPlantCard',
    route: '/garden',
    expectedName: 'GardenPlantCard',
    selectors: ['[data-testid*="plant" i]', '[class*="plant" i][class*="card" i]', '[class*="seed" i][class*="card" i]', 'article', '[class*="card" i]'],
  },
  {
    surface: 'OrchardTreeCard',
    route: '/orchard',
    expectedName: 'OrchardTreeCard',
    selectors: ['[data-testid*="tree" i]', '[class*="tree" i][class*="card" i]', 'article', '[class*="card" i]'],
  },
  {
    surface: 'BeerBottleCard',
    route: '/beer',
    expectedName: 'BeerBottleCard',
    selectors: ['[data-testid*="beer" i]', '[class*="beer" i][class*="card" i]', '[class*="bottle" i][class*="card" i]', 'article', '[class*="card" i]'],
  },
  {
    surface: 'MushroomCard',
    route: '/mushrooms',
    expectedName: 'MushroomCard',
    selectors: ['[data-testid*="mushroom" i]', '[class*="mushroom" i][class*="card" i]', 'article', '[class*="card" i]'],
  },
  {
    surface: 'FamilyCard',
    route: '/family',
    expectedName: 'FamilyCard',
    selectors: ['[data-testid*="family" i]', '[class*="family" i][class*="card" i]', '[class*="person" i][class*="card" i]', 'article', '[class*="card" i]'],
  },
];
